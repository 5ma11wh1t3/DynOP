...
def sort_edges(gadgets_info,edges):
    ...
    return res
def main(binary, file_fold, gadgets_info = None, mem_search_depth=1, reg_search_depth=3, res_json={},valid_mem_reg_num=1,mem_reg_timeout=2*60,reg_timout=10*60,target_type="funcall4"):
    # global res_json
    if gadgets_info == None:
        gadgets_info = info_init(binary,file_fold,target_type)
